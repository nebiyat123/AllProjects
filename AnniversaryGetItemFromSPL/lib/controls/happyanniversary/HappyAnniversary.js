...
var HappyAnniversary = (function (_super) {
    ...
    function HappyAnniversary(props) {
        ...
        _this._showAnniversarys = true;
        return _this;
    }
    HappyAnniversary.prototype.componentDidMount = function () {
    ...
    HappyAnniversary.prototype.componentDidUpdate = function (prevProps, prevState) {
    };
    //
    HappyAnniversary.prototype.render = function () {
        return (React.createElement("div", { className: styles.happyAnniversary }, this.props.users.map(function (user) {
            return (React.createElement("div", { className: styles.container },
                React.createElement(HappyBirdthayCard, { userName: user.userName, jobDescription: user.jobDescription, anniversary: moment(user.anniversary, ["MM-DD-YYYY", "YYYY-MM-DD", "DD/MM/YYYY", "MM/DD/YYYY"]).format('Do MMMM'), userEmail: user.userEmail, Ann_days: user.Ann_days })));
        })));
    };
