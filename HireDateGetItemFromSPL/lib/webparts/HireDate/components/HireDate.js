...
var HireDates = (function (_super) {
    ...
    HireDates.prototype.GetUsers = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _otherMonthsHireDates, _dezemberHireDates, CurrentYear, listItems, _i, listItems_1, item;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._spServices.getPHireDates(this.props.numberUpcomingDays)];
                    case 1:
                        listItems = _a.sent();
                        if (listItems && listItems.length > 0) {
                            ...
                            for (_i = 0, listItems_1 = listItems; _i < listItems_1.length; _i++) {
                                item = listItems_1[_i];
                                this._users.push({ key: item.fields.email, userName: item.fields.Title, userEmail: item.fields.email, jobDescription: item.fields.JobTitle, hiredate: moment.utc(item.fields.HireDate).local().format() });
                            }
                        }
                        //  this._users=[];
                        this.setState({
