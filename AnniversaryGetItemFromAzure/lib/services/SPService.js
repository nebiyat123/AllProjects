...
var SPService = (function () {
    function SPService(_context) {
        ...
        this.AnniversaryListTitle = "Anniversaries";
    }
    // Get Profiles
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.graphClient.api("users?$select=mail,displayName,jobTitle,jobTitle&$top=999")
                                .version('beta')
                                .get()];
                    case 3:
                        _results = _b.sent();
                    ...
                    case 6:
                        ...
                        _Userresults = _Userresults.concat(_results.value);
                        _b.label = 7;
                    case 7: return [2 /*return*/, _Userresults];
                    case 8:
                        error_1 = _b.sent();
                        console.dir(error_1);
